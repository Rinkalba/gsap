...
const GsapStagger = () => {
  ...
  useGSAP(()=>{
    timeline.to('.stagger-box',{
      ...
      y: 250, // duration of each animation
      ratotaion: 360, // easing function for each animation
      // repeat: -1, // repeat the animation indefinitely
      // yoyo: true,
      borderRadius:'100%', // repeat the animation indefinitely, but with the reverse direction each time
      ease:'circ.inOut'
    ...
    timeline.to('.stagger-box',{
      ...
      y: 500, // duration of each animation
      ratotaion: 360, // easing function for each animation
      borderRadius:'100%', // repeat the animation indefinitely, but with the reverse direction each time
      ease:'circ.inOut',
